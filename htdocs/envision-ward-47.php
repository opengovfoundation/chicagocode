		...
		<div class="nest">
			...
			<section class="secondary-content">
				...
				<article class="abstract">
					...
					<img src="/themes/ChicagoCode2013/static/images/ward47.jpg" style="max-width: 100%" alt="Map of Ward 47">
