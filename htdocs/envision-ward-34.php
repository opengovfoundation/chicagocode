	...
	<section class="homepage" role="main">
		<div class="nest">
			<section class="feature-content">
				...
				<p>
				<strong>Hello Chicago Excel Academy of Roseland! Welcome to the <a href="/envision/">Envision Chicago</a> scholarship contest!</strong>
				</p>
				<p>
			...
			<section class="secondary-content">
				...
				<article class="abstract">
					...
					<img src="/themes/ChicagoCode2013/static/images/ward34.jpg" style="max-width: 100%" alt="Map of Ward 34">
